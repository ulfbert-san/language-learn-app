...
class $LernSetsTable extends LernSets with TableInfo<$LernSetsTable, LernSet> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $LernSetsTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
    'id',
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'lern_sets';
  @override
  VerificationContext validateIntegrity(
    Insertable<LernSet> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  LernSet map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return LernSet(
      id: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
  ...
  @override
  $LernSetsTable createAlias(String alias) {
    return $LernSetsTable(attachedDatabase, alias);
  }
}

class LernSet extends DataClass implements Insertable<LernSet> {
  final int id;
  final String name;
  ...
  LernSetsCompanion toCompanion(bool nullToAbsent) {
    return LernSetsCompanion(
      id: Value(id),
      name: Value(name),
  ...
  LernSet copyWithCompanion(LernSetsCompanion data) {
    return LernSet(
      id: data.id.present ? data.id.value : this.id,
      name: data.name.present ? data.name.value : this.name,
...
class LernSetsCompanion extends UpdateCompanion<LernSet> {
  final Value<int> id;
  final Value<String> name;
  ...
  static Insertable<LernSet> custom({
    Expression<int>? id,
    Expression<String>? name,
  ...
  @override
  String toString() {
    return (StringBuffer('LernSetsCompanion(')
          ..write('id: $id, ')
          ..write('name: $name, ')
          ..write('description: $description, ')
          ..write('folderId: $folderId, ')
...
class $FlashcardsTable extends Flashcards
  ...
  static const VerificationMeta _lernSetIdMeta = const VerificationMeta(
    'lernSetId',
  );
  @override
  late final GeneratedColumn<int> lernSetId = GeneratedColumn<int>(
    'lern_set_id',
    aliasedName,
    false,
    type: DriftSqlType.int,
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('lern_set_id')) {
      context.handle(
        _lernSetIdMeta,
        lernSetId.isAcceptableOrUnknown(data['lern_set_id']!, _lernSetIdMeta),
      );
    } else if (isInserting) {
      context.missing(_lernSetIdMeta);
    }
  ...
  Flashcard map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Flashcard(
      ...
      lernSetId: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}lern_set_id'],
      )!,
...
class Flashcard extends DataClass implements Insertable<Flashcard> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
    map['id'] = Variable<int>(id);
    map['lern_set_id'] = Variable<int>(lernSetId);
  ...
  factory Flashcard.fromJson(
    ...
    return Flashcard(
      id: serializer.fromJson<int>(json['id']),
      lernSetId: serializer.fromJson<int>(json['lernSetId']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      'id': serializer.toJson<int>(id),
      'lernSetId': serializer.toJson<int>(lernSetId),
  ...
  Flashcard copyWithCompanion(FlashcardsCompanion data) {
    return Flashcard(
      id: data.id.present ? data.id.value : this.id,
      lernSetId: data.lernSetId.present ? data.lernSetId.value : this.lernSetId,
...
class FlashcardsCompanion extends UpdateCompanion<Flashcard> {
  ...
  static Insertable<Flashcard> custom({
    ...
    return RawValuesInsertable({
      if (id != null) 'id': id,
      if (lernSetId != null) 'lern_set_id': lernSetId,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (lernSetId.present) {
      map['lern_set_id'] = Variable<int>(lernSetId.value);
    }
    if (word.present) {
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  late final $LernSetsTable lernSets = $LernSetsTable(this);
...
final class $$FoldersTableReferences
  ...
  static MultiTypedResultKey<$LernSetsTable, List<LernSet>> _lernSetsRefsTable(
    _$AppDatabase db,
  ) => MultiTypedResultKey.fromTable(
    db.lernSets,
    aliasName: $_aliasNameGenerator(db.folders.id, db.lernSets.folderId),
  );

  $$LernSetsTableProcessedTableManager get lernSetsRefs {
    final manager = $$LernSetsTableTableManager(
      $_db,
      $_db.lernSets,
    ).filter((f) => f.folderId.id.sqlEquals($_itemColumn<int>('id')!));

    final cache = $_typedResult.readTableOrNull(_lernSetsRefsTable($_db));
...
class $$FoldersTableFilterComposer
  ...
  Expression<bool> lernSetsRefs(
    Expression<bool> Function($$LernSetsTableFilterComposer f) f,
  ) {
    final $$LernSetsTableFilterComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.id,
      referencedTable: $db.lernSets,
...
class $$FoldersTableAnnotationComposer
  ...
  Expression<T> lernSetsRefs<T extends Object>(
    Expression<T> Function($$LernSetsTableAnnotationComposer a) f,
  ) {
    final $$LernSetsTableAnnotationComposer composer = $composerBuilder(
      ...
      builder:
          (
            ...
            $addJoinBuilderToRootComposer,
            $removeJoinBuilderFromRootComposer,
          }) => $$LernSetsTableAnnotationComposer(
            $db: $db,
            $table: $db.lernSets,
            $addJoinBuilderToRootComposer: $addJoinBuilderToRootComposer,
            joinBuilder: joinBuilder,
...
class $$FoldersTableTableManager
    extends
        RootTableManager<
          ...
          Folder,
          PrefetchHooks Function({bool lernSetsRefs})
        > {
    ...
    : super(
        TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              ...
              .toList(),
          prefetchHooksCallback: ({lernSetsRefs = false}) {
            return PrefetchHooks(
              db: db,
              explicitlyWatchedTables: [if (lernSetsRefs) db.lernSets],
              addJoins: null,
              getPrefetchedDataCallback: (items) async {
                return [
                  if (lernSetsRefs)
                    await $_getPrefetchedData<Folder, $FoldersTable, LernSet>(
                      currentTable: table,
                      referencedTable: $$FoldersTableReferences
                          ._lernSetsRefsTable(db),
                      managerFromTypedResult: (p0) =>
                          $$FoldersTableReferences(db, table, p0).lernSetsRefs,
...
typedef $$FoldersTableProcessedTableManager =
    ProcessedTableManager<
      ...
      PrefetchHooks Function({bool lernSetsRefs})
    >;
typedef $$LernSetsTableCreateCompanionBuilder =
    LernSetsCompanion Function({
      Value<int> id,
      required String name,
      Value<String?> description,
      Value<int?> folderId,
...
typedef $$LernSetsTableUpdateCompanionBuilder =
    LernSetsCompanion Function({
      Value<int> id,
      Value<String> name,
      Value<String?> description,
...
final class $$LernSetsTableReferences
    extends BaseReferences<_$AppDatabase, $LernSetsTable, LernSet> {
  $$LernSetsTableReferences(super.$_db, super.$_table, super.$_typedResult);

  static $FoldersTable _folderIdTable(_$AppDatabase db) => db.folders
      .createAlias($_aliasNameGenerator(db.lernSets.folderId, db.folders.id));
  ...
  _flashcardsRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.flashcards,
    aliasName: $_aliasNameGenerator(db.lernSets.id, db.flashcards.lernSetId),
  );
  ...
  $$FlashcardsTableProcessedTableManager get flashcardsRefs {
    final manager = $$FlashcardsTableTableManager(
      $_db,
      $_db.flashcards,
    ).filter((f) => f.lernSetId.id.sqlEquals($_itemColumn<int>('id')!));
...
class $$LernSetsTableFilterComposer
    extends Composer<_$AppDatabase, $LernSetsTable> {
  $$LernSetsTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
  ...
  Expression<bool> flashcardsRefs(
    ...
    final $$FlashcardsTableFilterComposer composer = $composerBuilder(
      ...
      getReferencedColumn: (t) => t.lernSetId,
      builder:
          (
            joinBuilder, {
            $addJoinBuilderToRootComposer,
...
class $$LernSetsTableOrderingComposer
    extends Composer<_$AppDatabase, $LernSetsTable> {
  $$LernSetsTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$LernSetsTableAnnotationComposer
    extends Composer<_$AppDatabase, $LernSetsTable> {
  $$LernSetsTableAnnotationComposer({
    required super.$db,
    required super.$table,
...
class $$LernSetsTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
          $LernSetsTable,
          ...
          $$LernSetsTableOrderingComposer,
          $$LernSetsTableAnnotationComposer,
          $$LernSetsTableCreateCompanionBuilder,
          $$LernSetsTableUpdateCompanionBuilder,
          (LernSet, $$LernSetsTableReferences),
          LernSet,
          PrefetchHooks Function({bool folderId, bool flashcardsRefs})
        > {
  $$LernSetsTableTableManager(_$AppDatabase db, $LernSetsTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$LernSetsTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$LernSetsTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $$LernSetsTableAnnotationComposer($db: db, $table: table),
          updateCompanionCallback:
              ({
                Value<int> id = const Value.absent(),
                Value<String> name = const Value.absent(),
          ...
          withReferenceMapper: (p0) => p0
              .map(
                (e) => (
                  e.readTable(table),
                  $$LernSetsTableReferences(db, table, e),
                ),
              )
              .toList(),
                    ...
                    if (folderId) {
                      state =
                          state.withJoin(
                                ...
                                referencedTable: $$LernSetsTableReferences
                                    ._folderIdTable(db),
                                referencedColumn: $$LernSetsTableReferences
                                    ._folderIdTable(db)
                                    .id,
                              )
                              as T;
                ...
                return [
                  if (flashcardsRefs)
                    ...
                    >(
                      ...
                      managerFromTypedResult: (p0) => $$LernSetsTableReferences(
                        db,
                        table,
                        p0,
                      ).flashcardsRefs,
                      referencedItemsForCurrentItem: (item, referencedItems) =>
                          referencedItems.where((e) => e.lernSetId == item.id),
                      typedResults: items,
                    ),
                ];
              },
...
typedef $$LernSetsTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $LernSetsTable,
      LernSet,
...
final class $$FlashcardsTableReferences
  ...
  static $LernSetsTable _lernSetIdTable(_$AppDatabase db) =>
      db.lernSets.createAlias(
        $_aliasNameGenerator(db.flashcards.lernSetId, db.lernSets.id),
      );

  $$LernSetsTableProcessedTableManager get lernSetId {
    final $_column = $_itemColumn<int>('lern_set_id')!;

    final manager = $$LernSetsTableTableManager(
      $_db,
      $_db.lernSets,
    ).filter((f) => f.id.sqlEquals($_column));
    final item = $_typedResult.readTableOrNull(_lernSetIdTable($_db));
    if (item == null) return manager;
    return ProcessedTableManager(
      manager.$state.copyWith(prefetchedData: [item]),
    );
...
class $$FlashcardsTableFilterComposer
  ...
  $$LernSetsTableFilterComposer get lernSetId {
    final $$LernSetsTableFilterComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.lernSetId,
      referencedTable: $db.lernSets,
      getReferencedColumn: (t) => t.id,
      builder:
          (
...
class $$FlashcardsTableTableManager
    extends
        RootTableManager<
          ...
          Flashcard,
          PrefetchHooks Function({bool lernSetId})
        > {
    ...
    : super(
        TableManagerState(
          ...
          updateCompanionCallback:
              ({
                Value<int> id = const Value.absent(),
                Value<int> lernSetId = const Value.absent(),
          ...
          withReferenceMapper: (p0) => p0
              ...
              .toList(),
          prefetchHooksCallback: ({lernSetId = false}) {
            return PrefetchHooks(
              db: db,
...
class $AppDatabaseManager {
  ...
  $$LernSetsTableTableManager get lernSets =>
      $$LernSetsTableTableManager(_db, _db.lernSets);
